...
namespace ChaosGlitchMod
{
    class ChaosConsole : MonoBehaviour
    {
        ...
        public static float GlitchRandomAll = 0.2f;
        ...
        public static int RandomPitsRange = 0;
        ...
        private void Start()
        {
            if (autoUltra)
            {
                ...
                SharedHooks.InstallPrimaryHooks(true);
            ...
            ETGModConsole.Commands.GetGroup("chaos").AddUnit("bonus", delegate (string[] e)
            {
                ...
                if (!SharedHooks.IsHooksInstalled) { SharedHooks.InstallPrimaryHooks(true); }
            });
            ...
            {
                if (SharedHooks.IsHooksInstalled) { SharedHooks.InstallPrimaryHooks(false); } else { SharedHooks.InstallPrimaryHooks(true); }
            });
        }
    }
}
