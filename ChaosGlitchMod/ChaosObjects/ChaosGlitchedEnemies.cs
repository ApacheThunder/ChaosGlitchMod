...
namespace ChaosGlitchMod.ChaosObjects {
    ...
    public class ChaosGlitchedEnemies : MonoBehaviour {
        ...
        /*public static void ModifyActorPrefab(AIActor TargetEnemy, AIActor SourceEnemy, bool ExplodesOnDeath = false, bool spawnsGlitchedObjectOnDeath = false, Action<AIActor> SpecificEnemyMods = null) {            
            ...
            TargetEnemy.OverrideDisplayName = ("Glitched " + SourceEnemy.ActorName);
            TargetEnemy.ActorName = ("Glitched " + TargetEnemy.GetActorName());
            TargetEnemy.name = ("Glitched " + TargetEnemy.name);
            ...
            if (spawnsGlitchedObjectOnDeath) { TargetEnemy.healthHaver.gameObject.AddComponent<ChaosSpawnGlitchObjectOnDeath>(); }
