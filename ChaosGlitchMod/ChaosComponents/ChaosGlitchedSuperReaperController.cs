...
namespace ChaosGlitchMod.ChaosComponents {
    ...
    public class ChaosGlitchedSuperReaperController : BraveBehaviour {
        ...
        public ChaosGlitchedSuperReaperController() {
            // ShootTimer = 4.5f;
            MinSpeed = 3f;
            MaxSpeed = 6f;
        ...
        private static ChaosGlitchedSuperReaperController m_instance;

        public static ChaosGlitchedSuperReaperController Instance { get { return m_instance; } }
        ...
        private void Start() {
            ...
            healthHaver.gameObject.AddComponent<ChaosExplodeOnDeath>();
            ChaosExplodeOnDeath CachedExploder = healthHaver.GetComponent<ChaosExplodeOnDeath>();
            ...
            if (aiActor.GetComponentsInChildren<tk2dBaseSprite>(true) != null) {
                ...
                foreach (tk2dBaseSprite reaperSprite in aiActor.GetComponentsInChildren<tk2dBaseSprite>()) {
                    ChaosShaders.Instance.ApplyGlitchShader(null, reaperSprite, true, RandomIntervalFloat, RandomDispFloat, RandomDispIntensityFloat, RandomColorProbFloat, RnadomColorIntensityFloat);
                }
            }
