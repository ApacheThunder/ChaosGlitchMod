...
namespace ChaosGlitchMod {
    ...
    public class ChaosRatFloorRainController : MonoBehaviour {


        private static ChaosRatFloorRainController m_instance;

        public static ChaosRatFloorRainController Instance {
            get {
                if (!m_instance) {
                    m_instance = ETGModMainBehaviour.Instance.gameObject.AddComponent<ChaosRatFloorRainController>();
                }
                return m_instance;
            }
        }
        ...
        private IEnumerator ToggleRainFX(PlayerController player, float cachedRate) {
            ...
            if (GameObject.Find("Base_ResourcefulRat(Clone)") == null) { yield break; }
            if (GameObject.Find("ChaosRain") == null) { yield break; }
            if (GameObject.Find("ChaosLightning") == null) { yield break; }
