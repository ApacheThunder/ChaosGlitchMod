...
namespace ChaosGlitchMod.Textures.BootlegEnemies {
    ...
    public class BlueShotGunMan : MonoBehaviour {
        ...
        public static void Init(AIActor sourceActor = null) {
            ...
            BootlegBlueShotGunManCollection = ChaosUtility.BuildSpriteCollection(sourceActor.sprite.Collection, null, BootlegBlueShotGunManTextures, ShaderCache.Acquire("tk2d/BlendVertexColorUnlitTilted"), true);
